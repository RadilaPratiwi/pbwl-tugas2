...
<body>
	...
	<aside>
		...
		<header>
			<img src="<?php echo AST; ?>/img/Logo.jpeg" class="brand">
			...
			<ul>
				<li>
					<a href="<?php echo URL; ?>/dashboard">
						<img class="icon" src="<?php echo AST; ?>/img/menu4.png" alt=""> Home
					</a>
				</li>
				<li>
				...
				<li>
					<a href="<?php echo URL; ?>/users">
						<img class="icon" src="<?php echo AST; ?>/img/datauser.png" alt=""> Data Users
					</a>
				</li>
				<li>
					<a href="<?php echo URL; ?>/pelanggan">
						<img class="icon" src="<?php echo AST; ?>/img/datapelanggan.jpg" alt=""> Data Pelanggan
					</a>
				</li>
				<li>
	...
	<main>
		...
		<footer>
			Copyright &copy; 2023. Radila Pratiwi
		</footer>
	</main>
